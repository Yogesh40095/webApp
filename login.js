...
signup_frm.onsubmit = function(){
    ...
    if(user != "" && email != "" && phone != "" && pass != ""){
        ...
        signup_btn.innerHTML = " <i class='fa-solid fa-check'></i> Sign up successful !";
        setTimeout(function(){
...
// alert(localStorage.getItem("yogesh@gmail.com"));
...
if(localStorage.getItem(btoa(email.value))==null)
{
    ...
    email.onclick = function(){
        ...
        email.style.border.borderBottomColor = "#ccc";
    }
}
    ...
    if(btoa(email.value) == correct_email)
    {
    ...
    else
      {
        ...
        password.style.border.borderBottomColor = "#ccc"
        }
